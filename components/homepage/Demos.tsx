          ...
          from-emerald-500 via-teal-500 to-cyan-500 opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
                ...
                <div className='flex flex-col items-center text-center space-y-4 '>
                    ...
                    <div className='items-center mb-16'>
                        <h3 className='font-bold text-3xl max-w-2xl mx-auto px-4 sl:px-6'>
                            Let ChatPDF <span className='bg-linear-to-r from-orange-300 to-orange-600 bg-clip-text text-transparent'>handles all your file</span>, just simple ask questions.
                        </h3>
                    </div>
